            ...
            <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
                <div class="text">
                    <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span
                        ...
                        <span>${room.type}</span></p>
                    <h1 class="mb-4 bread">${room.type}</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        ...
                        <div class="single-slider owl-carousel">
                            <c:forEach var="imgDetail" items="${room.imagesDetail}">
                                <div class="item">
                                    <div class="room-img" style="background-image: url('/client/images/${imgDetail.imageUrl}.jpg');"></div>
                                </div>
                            </c:forEach>
                        </div>
                    </div>
                    <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                        ...
                        <div class="d-md-flex mt-5 mb-5">
                            <ul class="list">
                                <li><span>Max:</span> ${room.maxPerson} Persons</li>
                        ...
                        <div class="row">
                            <div class="col-sm col-md-6 ftco-animate">
                                <div class="room">
                                    <a href="rooms.html"
                                       ...
                                       style="background-image: url(/client/images/room-1.jpg);">
                            ...
                            <div class="col-sm col-md-6 ftco-animate">
                                <div class="room">
                                    <a href="rooms.html"
                                       class="img img-2 d-flex justify-content-center align-items-center"
                                       style="background-image: url(/client/images/room-2.jpg);">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
